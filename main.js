...
var $author$project$Main$KalenderMsg = function (a) {
	return {$: 2, a: a};
};
...
var $author$project$Liturgie$dateToIsoString = function (date) {
...
var $author$project$Main$buildLogString = function (liturgischeKalender) {
	...
	var datum = function () {
		...
		if (_v0.$ === 1) {
			...
			var d = _v0.a;
			return $author$project$Liturgie$dateToIsoString(d);
		}
	}();
	return A2(
		$elm$core$String$join,
...
var $author$project$Liturgie$GotCalender = function (a) {
	return {$: 2, a: a};
};
...
var $author$project$Liturgie$minimumDate = A3($justinmimbs$date$Date$fromCalendarDate, 1970, 0, 1);
...
var $author$project$Liturgie$buildParameters = F3(
	function (mode, filter, date) {
		...
		var endDate = function () {
			switch (mode) {
				case 3:
					return date;
				case 2:
					return A2($justinmimbs$date$Date$ceiling, 9, date);
				case 1:
					return A3(
		...
		var end = A3(
			...
			'-',
			'',
			$author$project$Liturgie$dateToIsoString(endDate));
		return '?start=' + (start + ('&end=' + (end + filterString)));
	});
...
var $author$project$Liturgie$Item = function (priority) {
	return function (typeShort) {
		return function (titleLong) {
			return function (titleShort) {
				return function (titleCode) {
					return function (color) {
						return function (codeProper) {
...
var $author$project$Liturgie$Groen = 0;
var $author$project$Liturgie$Paars = 3;
var $author$project$Liturgie$Rood = 1;
var $author$project$Liturgie$Roze = 4;
var $author$project$Liturgie$Wit = 2;
var $elm$json$Json$Decode$fail = _Json_fail;
var $author$project$Liturgie$liturgischeKleurDecoder = function (kleurString) {
	switch (kleurString) {
		case 'g':
		...
		default:
			return $elm$json$Json$Decode$fail('Fout bij het decoden van de liturgische kleur: ' + (kleurString + '!'));
	}
};
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Liturgie$itemDecoder = A2(
	$author$project$Liturgie$andMap,
	A2($elm$json$Json$Decode$field, 'codeExtra', $elm$json$Json$Decode$string),
	A2(
		$author$project$Liturgie$andMap,
		A2($elm$json$Json$Decode$field, 'codeDay', $elm$json$Json$Decode$string),
		A2(
			$author$project$Liturgie$andMap,
			A2($elm$json$Json$Decode$field, 'codeCommon', $elm$json$Json$Decode$string),
			A2(
				$author$project$Liturgie$andMap,
				A2($elm$json$Json$Decode$field, 'codeProper', $elm$json$Json$Decode$string),
				A2(
					$author$project$Liturgie$andMap,
					A2(
						$elm$json$Json$Decode$field,
						'color',
						A2($elm$json$Json$Decode$andThen, $author$project$Liturgie$liturgischeKleurDecoder, $elm$json$Json$Decode$string)),
					A2(
						$author$project$Liturgie$andMap,
						A2($elm$json$Json$Decode$field, 'titleCode', $elm$json$Json$Decode$string),
						A2(
							$author$project$Liturgie$andMap,
							A2($elm$json$Json$Decode$field, 'titleShort', $elm$json$Json$Decode$string),
							A2(
								$author$project$Liturgie$andMap,
								A2($elm$json$Json$Decode$field, 'titleLong', $elm$json$Json$Decode$string),
								A2(
									$author$project$Liturgie$andMap,
									...
									A2(
										...
										$elm$json$Json$Decode$succeed($author$project$Liturgie$Item)))))))))));
var $elm$json$Json$Decode$list = _Json_decodeList;
var $author$project$Liturgie$Advent = 1;
var $author$project$Liturgie$DoorHetJaar = 0;
var $author$project$Liturgie$Kerstnoveen = 2;
var $author$project$Liturgie$KersttijdNaOpenbaring = 4;
var $author$project$Liturgie$KersttijdVoorOpenbaring = 3;
var $author$project$Liturgie$Paastijd = 6;
var $author$project$Liturgie$Veertigdagentijd = 5;
var $author$project$Liturgie$seasonsDecoder = function (seasonString) {
	switch (seasonString) {
		case 'd':
			return $elm$json$Json$Decode$succeed(0);
		case 'a':
		...
		default:
			return $elm$json$Json$Decode$fail('Fout bij het decoden van de liturgische tijd!');
	}
};
var $author$project$Liturgie$dayInfoDecoder = A2(
	$author$project$Liturgie$andMap,
	A2(
		$elm$json$Json$Decode$field,
		'items',
		$elm$json$Json$Decode$list($author$project$Liturgie$itemDecoder)),
	A2(
		$author$project$Liturgie$andMap,
		A2(
			$elm$json$Json$Decode$field,
			'season',
			A2($elm$json$Json$Decode$andThen, $author$project$Liturgie$seasonsDecoder, $elm$json$Json$Decode$string)),
		A2(
			$author$project$Liturgie$andMap,
			A2($elm$json$Json$Decode$field, 'year12', $elm$json$Json$Decode$int),
			A2(
				$author$project$Liturgie$andMap,
				A2($elm$json$Json$Decode$field, 'yearABC', $elm$json$Json$Decode$string),
				A2(
					$author$project$Liturgie$andMap,
					A2($elm$json$Json$Decode$field, 'weekDayCorrected', $elm$json$Json$Decode$int),
					A2(
						$author$project$Liturgie$andMap,
						A2($elm$json$Json$Decode$field, 'weekDay', $elm$json$Json$Decode$int),
						A2(
							$author$project$Liturgie$andMap,
							A2($elm$json$Json$Decode$field, 'weekISOCorrected', $elm$json$Json$Decode$int),
							A2(
								$author$project$Liturgie$andMap,
								A2($elm$json$Json$Decode$field, 'weekISO', $elm$json$Json$Decode$int),
								A2(
									$author$project$Liturgie$andMap,
									A2($elm$json$Json$Decode$field, 'weekTitle', $elm$json$Json$Decode$string),
									$elm$json$Json$Decode$succeed($author$project$Liturgie$DayInfo))))))))));
...
var $author$project$Liturgie$calenderDecoder = A2(
	$elm$json$Json$Decode$map,
	$elm$core$Dict$fromList,
	$elm$json$Json$Decode$keyValuePairs($author$project$Liturgie$dayInfoDecoder));
...
var $author$project$Liturgie$resultToMsg = F3(
	function (toParentMsg, dataToMsg, result) {
		if (!result.$) {
			var a = result.a;
			return toParentMsg(
				dataToMsg(a));
			...
			var e = result.a;
			return toParentMsg(
				$author$project$Liturgie$GotLiturgieHttpError(e));
		}
	});
var $author$project$Liturgie$getCalender = F4(
	function (toParentMsg, mode, filter, date) {
		if (date.$ === 1) {
			...
			return $elm$http$Http$get(
				{
					...
					bU: 'https://tiltenberg.org/kerkkalender/get_kerkkalender.php' + A3($author$project$Liturgie$buildParameters, mode, filter, d)
				});
		}
	});
...
var $author$project$Liturgie$SetModelDate = function (a) {
	return {$: 10, a: a};
};
...
var $author$project$Liturgie$changeDate = F2(
	function (model, direction) {
		...
		if (_v0.$ === 1) {
			...
			var d = _v0.a;
			var newDate = A3($justinmimbs$date$Date$add, unit, direction, d);
			var newDateCorrected = function () {
				var _v1 = A2($justinmimbs$date$Date$compare, newDate, $author$project$Liturgie$minimumDate);
				switch (_v1) {
					case 0:
						return $author$project$Liturgie$minimumDate;
					case 1:
			...
			return $elm$core$Maybe$Just(newDateCorrected);
		}
	});
var $author$project$Liturgie$getCalenderLijst = function (calenderData) {
	switch (calenderData.$) {
		case 0:
			return $elm$core$Dict$empty;
		case 2:
			var lijst = calenderData.a;
			return lijst;
		default:
			var lijst = calenderData.a;
			return lijst;
...
var $author$project$Liturgie$httpError = function (error) {
	switch (error.$) {
		case 0:
			var string = error.a;
			return string;
		...
		case 3:
			var _int = error.a;
			return 'Foutcode' + $elm$core$String$fromInt(_int);
		default:
			var string = error.a;
			return string;
	}
};
var $author$project$Liturgie$setLoadingCalenderData = F2(
	function (calender, newDate) {
		switch (calender.$) {
			case 1:
				var dict = calender.a;
				return $author$project$Liturgie$Loading(dict);
			case 2:
				var dict = calender.a;
				var _v1 = A2(
					$elm$core$Dict$get,
					$author$project$Liturgie$dateToIsoString(newDate),
					dict);
				if (_v1.$ === 1) {
					return $author$project$Liturgie$Loading(dict);
				} else {
					var d = _v1.a;
					return $author$project$Liturgie$Success(dict);
				}
			default:
	...
	function (toParentMsg, msg, model) {
		switch (msg.$) {
			...
			case 1:
				...
				var month = msg.b;
				var day = msg.c;
				var today = A3($justinmimbs$date$Date$fromCalendarDate, year, month, day);
...
var $author$project$Main$initUrl = F2(
	function (kruimelpad, liturgischeKalender) {
		if (kruimelpad.$ === 1) {
			return liturgischeKalender;
		} else {
			var _v1 = kruimelpad.a;
			var mode = _v1.a;
			var date = _v1.b;
			return A3(
				$author$project$Liturgie$update,
				$author$project$Main$KalenderMsg,
				$author$project$Liturgie$SetModelDate(date),
				A3(
					$author$project$Liturgie$update,
					$author$project$Main$KalenderMsg,
					$author$project$Liturgie$ChangeMode(mode),
					liturgischeKalender));
		}
	});
...
var $author$project$Liturgie$stringToDate = function (string) {
...
var $author$project$Main$kruimelParser = A2(
	...
	$elm$url$Url$Parser$s('kerkkalender'),
	A2(
		$elm$url$Url$Parser$map,
		$elm$core$Tuple$pair,
		A2(
			$elm$url$Url$Parser$slash,
			A2($elm$url$Url$Parser$map, $author$project$Main$stringToMode, $elm$url$Url$Parser$string),
			A2($elm$url$Url$Parser$map, $author$project$Liturgie$stringToDate, $elm$url$Url$Parser$string))));
...
var $author$project$Main$init = F3(
	function (_v0, url, navKey) {
		var newLiturgischeKalender = A2(
			$author$project$Main$initUrl,
			A2($elm$url$Url$Parser$parse, $author$project$Main$kruimelParser, url),
...
var $author$project$Liturgie$GotToday = F3(
	function (a, b, c) {
...
var $PanagiotisGeorgiadis$elm_datetime$DateTime$Internal$fromPosix = function (timePosix) {
	return {
		g: $PanagiotisGeorgiadis$elm_datetime$Calendar$Internal$fromPosix(timePosix),
		b: $PanagiotisGeorgiadis$elm_datetime$Clock$Internal$fromPosix(timePosix)
	};
};
...
var $author$project$Liturgie$createDate = F3(
	function (year, month, day) {
		return A3($justinmimbs$date$Date$fromCalendarDate, year, month, day);
	});
var $author$project$Liturgie$dateToString = function (date) {
	return A2($justinmimbs$date$Date$format, 'd-M-y', date);
};
var $author$project$Liturgie$liturgieMsgToString = function (msg) {
	switch (msg.$) {
		case 0:
			return 'NoOp';
		case 1:
			...
			var month = msg.b;
			var day = msg.c;
			return 'GotToday ' + $author$project$Liturgie$dateToString(
				A3($author$project$Liturgie$createDate, year, month, day));
		case 2:
			var days = msg.a;
			return 'GotCalender';
		case 3:
			var error = msg.a;
			return 'GotLiturgieHttpError ' + $author$project$Liturgie$httpError(error);
		case 4:
			var mode = msg.a;
			return 'ChangeMode';
		case 5:
		...
		case 7:
			return 'ToToday';
		case 8:
			return 'ToggleShowKalender';
		case 9:
			var mssDate = msg.a;
			return 'SetSelected';
		case 10:
			var date = msg.a;
			return 'SetModelDate ' + $author$project$Liturgie$dateToString(date);
		case 11:
			var date = msg.a;
			return 'ClickDate ' + $author$project$Liturgie$dateToString(date);
		case 12:
			var _v1 = msg.a;
			var maand = _v1.a;
			var jaar = _v1.b;
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
				...
				var newLiturgischeKalender = function () {
					if (newRoute.$ === 1) {
						...
						return A3(
							$author$project$Liturgie$update,
							$author$project$Main$KalenderMsg,
							$author$project$Liturgie$SetModelDate(r.b),
							A3(
								$author$project$Liturgie$update,
								$author$project$Main$KalenderMsg,
			...
			case 1:
				var nuPosix = msg.a;
				var nu = $PanagiotisGeorgiadis$elm_datetime$DateTime$fromPosix(nuPosix);
				var newLiturgischeKalender = A3(
					$author$project$Liturgie$update,
					$author$project$Main$KalenderMsg,
					A3(
						$author$project$Liturgie$GotToday,
...
var $author$project$Liturgie$monthToFullString = function (month) {
	switch (month) {
		case 0:
			return 'januari';
		case 1:
...
var $author$project$Liturgie$dateToMonthYearString = function (date) {
	return $elm$core$String$concat(
		_List_fromArray(
			[
				$author$project$Liturgie$monthToFullString(
				$justinmimbs$date$Date$month(date)),
				' ',
				$elm$core$String$fromInt(
				$justinmimbs$date$Date$year(date))
...
var $author$project$Liturgie$dateToWeeknumber = function (date) {
	return $justinmimbs$date$Date$weekNumber(
		A3($justinmimbs$date$Date$add, 3, 1, date));
};
var $author$project$Liturgie$dateToYearInt = function (date) {
	return $justinmimbs$date$Date$year(date);
};
var $author$project$Main$liturgieModelToHistoryString = function (liturgischeKalender) {
	var _v0 = liturgischeKalender.g;
	if (_v0.$ === 1) {
		return '';
	} else {
			...
			case 1:
				return $elm$core$String$concat(
					_List_fromArray(
						[
							': ',
							$author$project$Liturgie$dateToMonthYearString(date)
						]));
			case 2:
				return $elm$core$String$concat(
					_List_fromArray(
						[
							': week ',
							$elm$core$String$fromInt(
							$author$project$Liturgie$dateToWeeknumber(date)),
							' (',
							$elm$core$String$fromInt(
							$author$project$Liturgie$dateToYearInt(date)),
							')'
...
var $author$project$Liturgie$viewLabelTextDiv = F3(
	function (className, labelText, textString) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
...
var $author$project$Liturgie$viewDateheader = function (date) {
	return A3(
...
var $author$project$Liturgie$ClickDate = function (a) {
	return {$: 11, a: a};
};
var $elm$html$Html$a = _VirtualDom_node('a');
var $author$project$Liturgie$buildMissaalUrl = function (date) {
	return 'https://www.tiltenberg.org/missaal/0/?date=' + $author$project$Liturgie$dateToIsoString(date);
};
...
var $author$project$Liturgie$seasonToString = function (season) {
	switch (season) {
		case 0:
			return 'tijd door het jaar';
		case 1:
			return 'advent';
		case 2:
			return 'advent (kerstnoveen)';
		case 3:
			return 'kersttijd (vóór Openbaring)';
		case 4:
			return 'kersttijd (na Openbaring)';
		case 5:
			return 'veertigdagentijd';
		default:
			return 'paastijd';
	}
};
...
var $author$project$Liturgie$getTypeLong = F3(
	function (codeProper, priority, typeShort) {
		switch (typeShort) {
			case 'a':
				return '';
			case 'f':
			...
			case '':
				return A2(
					...
					codeProper,
					_List_fromArray(
						['598', '097', '098'])) ? 'paastriduum' : (A2(
					$elm$core$List$member,
					priority,
					_List_fromArray(
						[90, 120, 85])) ? 'vrije gedachtenis' : '');
			default:
				return 'fout';
		}
	});
var $author$project$Liturgie$getTypeShort = function (typeShort) {
	if (typeShort === 'a') {
		return '';
	} else {
		return typeShort;
	...
	function (date, season, item) {
		...
		var nietGloria = _List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(beginGloria + 'blijft achterwege.')
					]))
			]);
		var welGloria = _List_fromArray(
			[
				A2(
				$elm$html$Html$div,
				_List_fromArray(
		...
		var _v0 = function () {
			if ($justinmimbs$date$Date$weekday(date) === 6) {
				switch (season) {
					case 0:
						return _Utils_Tuple2(welGloria, welCredo);
					case 1:
						return _Utils_Tuple2(nietGloria, welCredo);
					case 2:
						return _Utils_Tuple2(nietGloria, welCredo);
					case 3:
						return _Utils_Tuple2(welGloria, welCredo);
		...
		var kopje = _Utils_eq(inhoud, _List_Nil) ? _List_Nil : _List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Eucharistieviering')
					]))
			]);
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('eucharistie')
				]),
...
var $author$project$Liturgie$viewDay = F6(
	function (toParentMsg, today, modelDate, selectedDate, date, dayInfo) {
		var timelineClass = function () {
			if (today.$ === 1) {
				return '';
			} else {
				var td = today.a;
				var _v1 = A2($justinmimbs$date$Date$compare, date, td);
				switch (_v1) {
					case 0:
						return 'past';
					case 1:
		...
		var selectedClass = _Utils_eq(
			selectedDate,
			$elm$core$Maybe$Just(date)) ? 'selected' : '';
		var positieMaandkalender = $justinmimbs$date$Date$day(date) + ($justinmimbs$date$Date$weekdayNumber(
			A2($justinmimbs$date$Date$floor, 2, date)) % 7);
		var modelDateClass = _Utils_eq(
			modelDate,
			$elm$core$Maybe$Just(date)) ? 'modeldate' : '';
		var className = A2(
			$elm$core$String$join,
			' ',
			A2(
					...
					A2(
						...
						A2(
							...
							A2(
								...
								_List_fromArray(
									[
										'pos' + $elm$core$String$fromInt(positieMaandkalender)
									]),
								A2(
									$elm$core$List$append,
									_List_fromArray(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					toParentMsg(
						$author$project$Liturgie$ClickDate(date)))
				]),
			$elm$core$List$concat(
				_List_fromArray(
					[
						...
						[
							...
							_List_fromArray(
								[
									...
									$author$project$Liturgie$buildMissaalUrl(date)),
									$elm$html$Html$Attributes$target('_blank'),
									$elm$html$Html$Attributes$class('missaalUrl')
								]),
							_List_fromArray(
								[
									$elm$html$Html$text('Teksten Eucharistie')
								]))
						]),
						A2(
						$elm$core$List$map,
...
var $author$project$Liturgie$viewDays = F6(
	function (toParentMsg, today, modelDate, selectedDate, cal, date) {
		var mssDayInfo = A2(
			$elm$core$Dict$get,
			$author$project$Liturgie$dateToIsoString(date),
			cal);
		if (mssDayInfo.$ === 1) {
			return A2(
				$elm$html$Html$div,
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Datum niet gevonden!')
					]));
		} else {
			var dayInfo = mssDayInfo.a;
			return A6($author$project$Liturgie$viewDay, toParentMsg, today, modelDate, selectedDate, date, dayInfo);
		}
	});
var $author$project$Liturgie$ClickMonth = function (a) {
	return {$: 12, a: a};
};
var $author$project$Liturgie$viewMonthheader = F2(
	function (toParentMsg, _v0) {
		var year = _v0.a;
		var month = _v0.b;
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					...
					$elm$html$Html$Events$onClick(
					toParentMsg(
						$author$project$Liturgie$ClickMonth(
							_Utils_Tuple2(month, year))))
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								_List_fromArray(
									[
										$author$project$Liturgie$monthToFullString(month),
...
var $author$project$Liturgie$viewWeekheader = function (headerString) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('header ' + headerString)
			]),
		_List_fromArray(
			[
				$elm$html$Html$text(headerString)
			]));
};
var $author$project$Liturgie$viewWeekheaders = function () {
	var headers = _List_fromArray(
		['nummer', 'zondag', 'maandag', 'dinsdag', 'woensdag', 'donderdag', 'vrijdag', 'zaterdag']);
	return A2($elm$core$List$map, $author$project$Liturgie$viewWeekheader, headers);
}();
var $author$project$Liturgie$viewWeeknumbers = F2(
	function (index, weeknumber) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class(
					'weeknummer nr' + $elm$core$String$fromInt(index + 1))
				]),
			_List_fromArray(
				[
					$elm$html$Html$text(
...
var $author$project$Liturgie$viewMonth = F8(
	function (toParentMsg, today, modelDate, selectedDate, mode, showSundaysOnly, cal, monthInt) {
		var month = $justinmimbs$date$Date$numberToMonth(monthInt);
		var maandCal = A2(
				...
				function (date, info) {
					return _Utils_eq(
						$justinmimbs$date$Date$month(
							$author$project$Liturgie$stringToDate(date)),
						month);
				}),
			cal);
		var datumsInMaand = A2(
			$elm$core$List$filter,
			A2($author$project$Liturgie$filterByShowSundaysOnly, mode, showSundaysOnly),
			A2(
				$elm$core$List$sortWith,
				$justinmimbs$date$Date$compare,
				A2(
					$elm$core$List$map,
					$author$project$Liturgie$stringToDate,
					$elm$core$Dict$keys(maandCal))));
		var aanwezigeWeeknummers = $elm_community$list_extra$List$Extra$unique(
			A2($elm$core$List$map, $author$project$Liturgie$dateToWeeknumber, datumsInMaand));
		var aanwezigeJaarMaanden = $elm_community$list_extra$List$Extra$unique(
			A2(
				$elm$core$List$map,
				function (date) {
					return _Utils_Tuple2(
			...
			$elm$core$List$concat(
				_List_fromArray(
					[
						A2(
						$elm$core$List$map,
						$author$project$Liturgie$viewMonthheader(toParentMsg),
						aanwezigeJaarMaanden),
						$author$project$Liturgie$viewWeekheaders,
						A2($elm$core$List$indexedMap, $author$project$Liturgie$viewWeeknumbers, aanwezigeWeeknummers),
						A2(
						$elm$core$List$map,
						A5($author$project$Liturgie$viewDays, toParentMsg, today, modelDate, selectedDate, maandCal),
						datumsInMaand)
					])));
	});
var $author$project$Liturgie$viewMonths = F7(
	function (toParentMsg, today, modelDate, selectedDate, mode, showSundaysOnly, cal) {
		...
		switch (_v0) {
			...
			case 1:
				return A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('monthMode')
						]),
					$elm$core$List$concat(
						_List_fromArray(
							[
			...
			case 3:
				return A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('dayMode')
						]),
					$elm$core$List$concat(
						_List_fromArray(
							[
		...
		switch (_v0.$) {
			case 0:
				...
				return A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Fout bij het laden van de kalender. ' + error)
						]));
			case 1:
				var cal = _v0.a;
				return $elm$core$Dict$isEmpty(cal) ? A2(
					$elm$html$Html$div,
					_List_fromArray(
						[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Bezig met laden...')
						])) : A2(
					$elm$html$Html$div,
					_List_fromArray(
						[
					...
					_List_fromArray(
						[
							A3($author$project$Liturgie$viewCalenderData, toParentMsg, model, cal)
						]));
			default:
				var cal = _v0.a;
				return A2(
...
var $author$project$Liturgie$Next = {$: 5};
var $author$project$Liturgie$NoOp = {$: 0};
var $author$project$Liturgie$Previous = {$: 6};
...
var $author$project$Liturgie$viewControls = F3(
	function (toParentMsg, modelDate, today) {
		...
		var _v0 = function () {
			if (today.$ === 1) {
				return _Utils_Tuple2(true, $author$project$Liturgie$NoOp);
			} else {
				var td = today.a;
				return isDisabled ? _Utils_Tuple2(true, $author$project$Liturgie$NoOp) : _Utils_Tuple2(
					false,
					$author$project$Liturgie$SetModelDate(td));
			}
		}();
		var todayIsDisabled = _v0.a;
		var todayMsg = _v0.b;
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				...
				[
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$Events$onClick(
							toParentMsg($author$project$Liturgie$Previous))
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('<<')
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$disabled(todayIsDisabled),
							$elm$html$Html$Events$onClick(
							toParentMsg(todayMsg))
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('Vandaag')
						])),
					A2(
					$elm$html$Html$button,
					_List_fromArray(
						[
							$elm$html$Html$Attributes$disabled(isDisabled),
							$elm$html$Html$Events$onClick(
							toParentMsg($author$project$Liturgie$Next))
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('>>')
...
var $author$project$Liturgie$viewModeTabs = F2(
	function (toParentMsg, mode) {
		var className = F2(
			function (modelMode, button) {
				return _Utils_eq(modelMode, button) ? 'active' : '';
			});
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
...
var $author$project$Liturgie$viewCheckbox = F4(
	function (isChecked, isDisabled, msg, name) {
			...
			if (mode === 4) {
				return _List_fromArray(
					[
						...
						showSundaysOnly,
						false,
						toParentMsg($author$project$Liturgie$ToggleSundaysOnly),
						'Alleen zondagen')
					]);
			} else {
				return _List_Nil;
...
var $author$project$Liturgie$viewVandaag = function (today) {
	var htmlText = function () {
		if (today.$ === 1) {
			return 'Datum van vandaag nog onbekend. Even geduld.';
		} else {
			var d = today.a;
			return A2(
				$elm$core$String$join,
	...
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('vandaag')
			]),
		_List_fromArray(
			[
				$elm$html$Html$text(htmlText)
			]));
};
	...
	function (toParentMsg, model) {
		...
		if (_v0) {
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('liturgie')
					]),
				_List_fromArray(
					[
	...
	return {
		bn: _List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$id('kalender')
					]),
				_List_fromArray(
					[
